...
const MailListView = () => {
    const [mailingListData, setMailingListData] = useState<any>([]);
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>, mailingListUserId: string) => {
        e.preventDefault();
        deleteEmailFromMailingList(mailingListUserId)
        setTimeout(() => {
            fetchMailingLists()
        }, 1000)
